...
public class AjoutSuppPersonnel {
		...
		try {
			...
			switch(menu) {
				case 1 :
			    	...
			    	int idP = LectureClavier.lireEntier("") ;
			    	...
			    	int numRueP = LectureClavier.lireEntier("") ;
			    	
			    	System.out.print("Rue : ");
			    	String rueP = LectureClavier.lireChaine() ;
			    	
			    	System.out.print("Code postal : ");
			    	int codePostalP = LectureClavier.lireEntier("") ;
				...
				case 2: 
			    	...
			    	int idPSupp = LectureClavier.lireEntier("") ;
				...
				case 3:
			    	...
			    	int idH = LectureClavier.lireEntier("") ;
			    	...
			    	System.out.print("Numero de la rue : ");
			    	int numRueH = LectureClavier.lireEntier("") ;
			    	
			    	System.out.print("Rue : ");
			    	String rueH = LectureClavier.lireChaine() ;
			    	
			    	System.out.print("Code postal : ");
			    	int codePostalH = LectureClavier.lireEntier("") ;
				...
				case 4: 
			    	...
			    	int idHSupp = LectureClavier.lireEntier("") ;
